...
| **Tier 1 — pre-install** | install Flox into custom agent image | ~none (Flox will pre-installed) |
| **+ Binary cache** *(optional)* | cluster secrets + env | use with Tier 0 *or* 1; download from a cache |
